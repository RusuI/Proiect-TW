        ...
        <div class="box-container">
            ...
            <section class="menu" id="menu">
                ...
                <ul class="list" data-aos="fade-down">
                    ...
                    <li class="btn" data-src="../images/menu1.jpg">1 jalapeño (or serrano pepper instead)</li>
                ...
                <div class="row" data-aos="fade-right">
                    ...
                    <div class="content">
                        ...
                        <div class="info">
                            ...
                            <p>Mix in the remaining ingredients: Add in the onion, cilantro, jalapeño (or serrano), lime juice, salt, cumin, and tomatoes (if using) and stir until combined.</p>
                        </div>
                        <div class="info">
